...
#include "table.hpp"
#include "../ast/ast.hpp" // IMPORTANTE: antes de y.tab.h
#include "../parser/interpreter.tab.h" //  interpreter.tab.h contains the number values of the tokens produced by the parser
