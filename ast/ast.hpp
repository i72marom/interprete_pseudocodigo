...
/*!	
  ...
  \note    ConcatenacionNode Class publicly inherits from StringOperatorNode class 
		   and adds its own print and evaluate functions
*/
class ConcatenacionNode : public StringOperatorNode 
{
  public:

/*!		
	\brief Constructor of ConcatenacionNode uses StringOperatorNode's constructor as members initializer
	\param L: pointer to ExpNode
	\param R: pointer to ExpNode
	\post  A new ConcatenacionNode is created with the parameter
*/
  ConcatenacionNode(ExpNode *L, ExpNode *R): StringOperatorNode(L,R) 
  {
		// Empty
  }
/*!
...
/*!	
  \class   BorrarPantallaStmt
  \brief   Definition of atributes and methods of BorrarPantallaStmt class
  \note    BorrarPantallaStmt Class publicly inherits from Statement class 
		   and adds its own print and evaluate functions
  \warning  In this class, print and evaluate functions have the same meaning.
*/
class BorrarPantallaStmt: public Statement 
{
...
/*!
	\brief   Print the BorrarPantallaStmt
	\return  void
	\sa		 evaluate()
*/
  void print();
...
/*!	
	\brief   Evaluate the BorrarPantallaStmt
	\return  void
	\sa		 print
*/
  void evaluate();
...
/*!	
  \class   EntradaStmt
  \brief   Definition of atributes and methods of EntradaStmt class
  \note    EntradaStmt Class publicly inherits from Statement class 
		   and adds its own print and evaluate functions
  \warning  In this class, print and evaluate functions have the same meaning.
*/
class EntradaStmt: public Statement 
{

 public:
/*!		
	\brief Constructor of EntradaStmt 
	\post  A new EntradaStmt is created 
*/
  EntradaStmt() {}

/*!
	\brief   Print the EntradaStmt
	\return  void
	\sa		 evaluate()
*/
  void print();
...
/*!	
	\brief   Evaluate the EntradaStmt
	\return  void
	\sa		 print
*/
  void evaluate();
...
{
 private:
  std::string _varId;  //!< Id of the condition
  ExpNode * _from; //!< Iniciacion of the for statement
...
*/
  ForStmt(std::string varId,ExpNode *from, ExpNode *to,Statement *statement,  ExpNode * step=new lp::NumberNode(1))
	{
		this->_varId = varId;
		this->_from = from;
		this->_to = to;
